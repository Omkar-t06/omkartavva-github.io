...
function Footer(props) {
  ...
  return (
    <footer className='bg-ivory dark:bg-dark-navy text-teal dark:text-light-cyan shadow-md'>
      <hr className='border-t-2 border-teal dark:border-light-cyan'/>
      <section className='flex flex-col justify-center items-center gap-10 pt-20 px-0 pb-12'>
